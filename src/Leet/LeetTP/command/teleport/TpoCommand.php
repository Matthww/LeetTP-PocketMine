...
class TpoCommand implements CommandExecutor {
    ...
    public function onCommand(CommandSender $sender, Command $command, $label, array $args) {
        ...
        if(!$sender->hasPermission('leettp.command.tpo')) {
        ...
        $sender->sendMessage(sprintf($this->plugin->getMessageHandler()->tp_tpa_success, $target->getName()));
